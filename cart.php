...
<form id="frmcart" name="frmcart" method="post" action="?act=update">
  <table width="600" border="0" align="center" class="square">
    <tr>
      ...
      <b>รายการที่เลือก</span></td>
    </tr>
    <tr>
      <td bgcolor="#EAEAEA">รถ</td>
      <td align="center" bgcolor="#EAEAEA">ราคา</td>
      <td align="center" bgcolor="#EAEAEA">จำนวน(คัน)</td>
...
?>
<tr>
<td><a href="product.php">กลับหน้าเลือกรถ</a></td>
<td colspan="4" align="right">
    <input type="submit" name="button" id="button" value="ปรับปรุง" />
    <input type="button" name="Submit2" value="สั่งจอง" onclick="window.location='confirm.php';" />
</td>
</tr>
</table>
</form>
